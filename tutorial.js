...
let tutorialContent = [
    ["Welcome to Dynamic Pathfinder", "./images/welcome.gif", "Welcome to Dynamic Pathfinder, a visualization tool for search algorithms. Here, you can visualize both weighted and unweighted algorithms, and create obstacles for the search algorithms to navigate. Click 'next' to learn more."],
    ...
    ["Add Walls and Weights", "./images/wall-weight.gif", "Add walls or weights by clicking on the grid. Walls will be added when an unweighted search algorithm is currently selected, and weights will be added otherwise. Walls are impenetrable, while weights can be moved through with a default 'cost' of 5."],
    ["Add a Pattern", "./images/pattern.gif", "Add a pattern/maze to the board by selecting one from the top toolbar. All patterns/mazes are generated randomly."],
    ["Move the Start and Target Nodes", "./images/start-target.gif", "Move the start and target node by clicking on them with your mouse and dragging them to any empty node on the grid"],
    ["Run a Search or Clear the Board", "./images/run-clear.gif", "To run a search, click once on the 'run search' button. You will not be able to make any other actions while the search is running. To clear all nodes on the board, press the 'clear board' button."],
    ["Automatic Recomputation", "./images/recompute.gif", "Once a search has finished running, you can drag the start and target node into any unocupied square, which will cause the search space and shortest-path to automatically recompute."],
    ["Enjoy!", "./images/enjoy.gif", 'Please enjoy this application! If you would like to see the source code, you can find that on my <a href="https://github.com/Austin-T/Pathfinder">github</a>.']
];
